...
class ProcessTest(unittest.TestCase):
    ...
    def test_creates_logging_handlers(self):
        with patch('logging.StreamHandler') as stream_handler,\
                ...
                patch('os.path.expanduser') as expand_user:
            ...
            self.assertEqual(expand_user.call_args_list, [call('~/logs/process_name.log')])
            self.assertEqual(rotating_file_handler.call_args_list,
                             [call(expand_user.return_value, maxBytes=10000000, backupCount=10, encoding='utf-8')])
